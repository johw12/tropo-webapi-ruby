...
A Ruby library for interaction with the Telekom Tropo Web API using JSON.

More information could be found here: http://www.developergarden.com/apis/apis-sdks/telekom-tropo-api/

Our documentation could be found under section Telekom Tropo API here: http://www.developergarden.com/apis/docu-support/ 

== Telekom Tropo Web API Overview
